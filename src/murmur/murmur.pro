...
LANGUAGE	= C++
FORMS =
HEADERS *= Server.h ServerUser.h Meta.h PBKDF2.h Emote.h
SOURCES *= main.cpp Server.cpp ServerUser.cpp ServerDB.cpp Register.cpp Cert.cpp Messages.cpp Meta.cpp RPC.cpp PBKDF2.cpp Emote.cpp
